      ...
      <div class="content">
        ...
        <div class="content_box">
          <div class="contentBox_tabNav">
            ...
            <?php endif; ?>
						<?php if ($isSelf):  ?>
            --><a class="contentBox_tabNav_tab current" href="<?php echo site_url("user/$user->username/wishes/"); ?>">想借</a><!--
            ...
            <?php endif; ?>
					...
					<div id="user_books_list" class="wishes contents">
					     <ul class="books_list">
					          ...
					          <li id="book-<?php echo $book->id; ?>">
					               ...
					               <span class="book_time"><?php echo mdate('%Y-%m-%d', $book->time);
					 ?></span>
					               <span class="book_inventory"><?php echo "$realInventory / $inventory";  ?> 库存</span>
					               <span class="book_want"><?php echo $needs ?> 人想借</span>
					               <?php if($isSelf): ?>
					               <a href="<?php echo site_url("book/messages/mine/$book->id/"); ?>" class="book_more" statue="0">查看详细<img src="<?php echo site_url('include/style/img/').'books_list_more.png'; ?>" /></a>
					               <a href="<?php echo site_url("borrow/request_cancel_do/$book->id"); ?>" class="book_delete book_delete2 confirmAct" title="取消求书" confirmMessage="您确定要取消求书吗？">
					                    <img src="<?php echo site_url('include/style/img/').'books_list_delete.png'; ?>" />
					               </a>
					               <?php endif; ?>
					          </li>
					          <?php endforeach; ?>
