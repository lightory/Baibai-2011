    ...
    <div class="inner">
      ...
      <div class="sidebar">
        <div class="content_box blog_post_list">
          ...
          <ul>
            ...
            <?php }; ?>
				...
				<div class="content_box sidebar_snsLinks">
				  ...
				  <a href="http://t.qq.com/baibaibook/" class="sidebar_snsLinks_link" target="_blank">
            <img src="<?php echo site_url('include/style/img').'tqq.png'; ?>" />
          </a>
          ...
          <a href="http://twitter.com/baibaibook/" class="sidebar_snsLinks_link" target="_blank">
            <img src="<?php echo site_url('include/style/img').'twitter.png'; ?>" />
          </a>
				</div>
      </div>
